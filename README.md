...
For this project, I got the idea of making a pet sitter landing page when I had to take care of my friend's cats during their trip to Spain. And here again, I have another chance to optimize my knowledge in using **[HyperText Markup Language](https://en.wikipedia.org/wiki/HTML#:~:text=The%20HyperText%20Markup%20Language%20or,(HyperText%20Markup%20Language)) and [Cascading Style Sheets](https://en.wikipedia.org/wiki/CSS)** languages to code.
...
**Build an app that is functionally similar to [this](https://product-landing-page.freecodecamp.rocks/)**
...
* Then add [this link](https://kippulainen04.github.io/pet-journey/) to your internet browser
...
#### Credit:
* [(Heart Beating)](https://www.freecodecamp.org/news/how-to-create-a-beating-heart-with-pure-css-for-your-valentine-2aeb05e2d36e/) element credited by Dimitris Kiriakakis
